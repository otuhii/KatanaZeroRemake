...
Sprite* SpriteManager::CreateEmptySprite()
{
	Sprite* 
...
Sprite* SpriteManager::CreateCopySprite(const Sprite* pOriginal)
{
...
//void SpriteManager::CloneSprite(Sprite* pDestination, Sprite* pSource)
//{
