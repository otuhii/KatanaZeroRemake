...
public:
	...
	static int GetNextControlPointIdxByType(int currentIndex, int currentFloor, ControlPoint::ControlPointType type, const std::vector<ControlPoint>& controlPoints);
